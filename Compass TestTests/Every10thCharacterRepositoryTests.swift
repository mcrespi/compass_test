//
//  Every10thCharacterRepositoryTests.swift
//  Compass TestTests
//
...
class Every10thCharacterRepositoryTests: XCTestCase {
    ...
    override func setUp() {
        ...
        repository = Every10thCharacterRepository(
    ...
    func testFetchDataFromCacheSuccess() {
        let cachedDTO = Every10thCharacterDTO(rawText: "cached data")
        ...
        repository.fetchRawData()
            .sink(receiveCompletion: { completion in
                ...
                XCTAssertEqual(self.mockCacheDataSource.spyFetchData_key, "every10thCharacterRawData")
                XCTAssertTrue(self.mockCacheDataSource.spyFetchData_type == Every10thCharacterDTO.self)
    ...
    func testFetchDataFromNetworkSuccess() {
        ...
        repository.fetchRawData()
            .sink(receiveCompletion: { completion in
                ...
                XCTAssertEqual(self.mockCacheDataSource.spySaveData_key, "every10thCharacterRawData")
                XCTAssertTrue((self.mockCacheDataSource.spySaveData_data as? Every10thCharacterDTO)?.rawText == String(data: networkData, encoding: .utf8))
